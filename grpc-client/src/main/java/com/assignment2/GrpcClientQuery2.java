...
public class GrpcClientQuery2 {
    public static void main(String[] args) {
        ...
        EduQueryTwoServiceGrpc.EduQueryTwoServiceBlockingStub stub
                = EduQueryTwoServiceGrpc.newBlockingStub(channel);


        EduQueryTwoResponse eduQueryTwoResponse= stub.getEduQueryTwo(EduQueryTwoRequest.newBuilder()
                .setYear(2013)
                .setLength("4-year")
                .setType("Private")
        ...
        System.out.println(eduQueryTwoResponse);
