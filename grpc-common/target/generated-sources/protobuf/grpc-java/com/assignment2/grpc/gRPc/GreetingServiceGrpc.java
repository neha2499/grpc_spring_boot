...
public final class GreetingServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.assignment2.grpc.gRPc.GreetingService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.assignment2.grpc.gRPc.GreetingRequest,
      com.assignment2.grpc.gRPc.GreetingResponse> getGreetingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "greeting",
      requestType = com.assignment2.grpc.gRPc.GreetingRequest.class,
      responseType = com.assignment2.grpc.gRPc.GreetingResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.assignment2.grpc.gRPc.GreetingRequest,
      com.assignment2.grpc.gRPc.GreetingResponse> getGreetingMethod() {
    io.grpc.MethodDescriptor<com.assignment2.grpc.gRPc.GreetingRequest, com.assignment2.grpc.gRPc.GreetingResponse> getGreetingMethod;
      ...
      synchronized (GreetingServiceGrpc.class) {
        if ((getGreetingMethod = GreetingServiceGrpc.getGreetingMethod) == null) {
          GreetingServiceGrpc.getGreetingMethod = getGreetingMethod =
              io.grpc.MethodDescriptor.<com.assignment2.grpc.gRPc.GreetingRequest, com.assignment2.grpc.gRPc.GreetingResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "greeting"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.assignment2.grpc.gRPc.GreetingRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.assignment2.grpc.gRPc.GreetingResponse.getDefaultInstance()))
  ...
  public static abstract class GreetingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void greeting(com.assignment2.grpc.gRPc.GreetingRequest request,
        io.grpc.stub.StreamObserver<com.assignment2.grpc.gRPc.GreetingResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.assignment2.grpc.gRPc.GreetingRequest,
                com.assignment2.grpc.gRPc.GreetingResponse>(
  ...
  public static final class GreetingServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<GreetingServiceBlockingStub> {
    ...
    /**
     */
    public com.assignment2.grpc.gRPc.GreetingResponse greeting(com.assignment2.grpc.gRPc.GreetingRequest request) {
  ...
  public static final class GreetingServiceFutureStub extends io.grpc.stub.AbstractFutureStub<GreetingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.assignment2.grpc.gRPc.GreetingResponse> greeting(
        com.assignment2.grpc.gRPc.GreetingRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREETING:
          serviceImpl.greeting((com.assignment2.grpc.gRPc.GreetingRequest) request,
              (io.grpc.stub.StreamObserver<com.assignment2.grpc.gRPc.GreetingResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreetingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.assignment2.grpc.gRPc.Grpc.getDescriptor();
    }
